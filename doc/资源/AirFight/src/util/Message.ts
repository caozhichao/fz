...
class Message {
	...
	public static layer:egret.DisplayObjectContainer = null;
	...
	public static show(msg:string):void
	{
		...
		arr.push(item);
		item.alpha = 1;
		item.x = (Message.layer.stage.stageWidth-item.width)/2;
...
class MessageItem extends egret.DisplayObjectContainer{
		...
		public constructor(){
			...
			this._msgBackImg.texture = RES.getRes('toast-bg_png');
