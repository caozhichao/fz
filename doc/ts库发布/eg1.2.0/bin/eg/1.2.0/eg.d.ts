...
declare module eg {
    class Eg {
        ...
        constructor();
        static getInstance(): Eg;
        init(dis: egret.DisplayObjectContainer): void;
        /***
         * 声音解码失败处理
         */
...
declare module eg {
    ...
    class UILayer {
        ...
        static LAYER_SCENCE_FUNCTION: string;
        static LAYER_POPUP: string;
        static LAYER_ALERT: string;
        static LAYER_EFFECT: string;
        ...
        readonly popup: egret.Sprite;
        readonly alert: egret.Sprite;
        readonly scence: egret.Sprite;
        readonly sceceFunction: egret.Sprite;
        readonly effect: egret.Sprite;
        readonly loading: egret.Sprite;
    }
}
declare module eg {
...
declare module eg {
    class GImageButton extends eui.Image implements eg.IDispose {
        private flag;
        private curMatrix;
        private srcX;
        private srcY;
...
declare module eg {
    ...
    class UIManager {
         ...
         */
        showUI(cla: Function): IPage;
        showUI(page: eg.IPage): IPage;
        showUI(className: string): IPage;
        /**
         * 添加显示对象到对应的层
         */
        private show(page);
         ...
         * 根据UI类型关闭界面
         */
        closeUIByType(pageType: string): void;
        /**
         * 关闭UI
         */
        closeUI(page: IPage): void;
    }
}
declare module eg {
...
declare module eg {
    class WS extends egret.EventDispatcher {
        private static _instance;
        private _ws;
        constructor();
        ...
        sendData(bytes: egret.ByteArray): void;
...
declare module eg {
    ...
    class Description {
         ...
         * api api的名称
         */
        getAPI2(apiType: string, apiName: string): string;
        /**
         * 获取语言包数据
         */
...
declare module eg {
    ...
    class SceneScroll {
        ...
        private $pos;
        constructor(viewWith: number, viewHeight: number, maxWidth: number, maxHeight: number);
        /**
         * 根据移动目标计算场景的偏移量
         */
        updatePostion(x: number, y: number): egret.Point;
    }
}
declare module util {
    /**
...
declare module eg {
     ...
     * 虚拟摇杆
     */
    class VirtualJoystick extends egret.Sprite {
        private _bg;
        private _block;
        private $tempPos1;
        private $tempPos2;
